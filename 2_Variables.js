...
/* Rules: 
1. Must begin with a $, _ or a letter. 
eg: let 8harry = 7 // Not allowed this because of indetifier is staring with number.

2. We can't use reserved words
3. JS is case sensitive
4. Letters,digts, underscore and $ sign is only allowed.
